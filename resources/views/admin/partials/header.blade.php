@php
    ...
    $menu = [
        ...
        'distribution' => ['route' => 'admin.distribution.index', 'name' => '发布管理'],
    ...
    $subMap = [
        ...
        'admin.browser-profiles.index' => 'distribution',
        'admin.browser-profiles.create' => 'distribution',
        'admin.browser-profiles.store' => 'distribution',
        'admin.browser-profiles.edit' => 'distribution',
        'admin.browser-profiles.update' => 'distribution',
        'admin.browser-profiles.destroy' => 'distribution',
        'admin.browser-profiles.sync' => 'distribution',
        'admin.publish-tasks.index' => 'distribution',
        'admin.publish-tasks.create' => 'distribution',
        'admin.publish-tasks.store' => 'distribution',
        'admin.publish-tasks.show' => 'distribution',
        'admin.publish-tasks.execute' => 'distribution',
        'admin.publish-tasks.destroy' => 'distribution',
