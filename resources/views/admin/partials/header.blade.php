@php
    ...
    $menu = [
        'dashboard' => ['route' => 'admin.dashboard', 'name' => '首页'],
        'workflow' => ['route' => 'admin.workflow', 'name' => '发布流程'],
        'materials' => ['route' => 'admin.materials.index', 'name' => '素材准备'],
        'writing' => ['route' => 'admin.writing-instructions.index', 'name' => 'AI写作'],
        'tuozhan' => ['route' => 'admin.tuozhan.index', 'name' => '拓词工具'],
        'articles' => ['route' => 'admin.articles.index', 'name' => '文章管理'],
        'publish' => ['route' => 'admin.publish.dashboard', 'name' => '发布看板'],
        'distribution' => ['route' => 'admin.distribution.index', 'name' => '分发管理'],
        'tasks' => ['route' => 'admin.tasks.index', 'name' => '任务管理'],
        'analytics' => ['route' => 'admin.analytics', 'name' => '数据中心'],
        'geo-optimization' => ['route' => 'admin.geo-optimization.index', 'name' => 'GEO优化'],
        'ai_config' => ['route' => 'admin.ai.configurator', 'name' => '系统设置'],
    ];
    if ($isSuperAdmin) {
    ...
    $subMap = [
        ...
        'admin.writing-instructions.index' => 'writing',
        'admin.writing-instructions.create' => 'writing',
        'admin.writing-instructions.edit' => 'writing',
        'admin.writing-instructions.store' => 'writing',
        'admin.writing-instructions.update' => 'writing',
        'admin.writing-instructions.destroy' => 'writing',
        'admin.writing-tasks.index' => 'writing',
        'admin.writing-tasks.create' => 'writing',
        'admin.writing-tasks.show' => 'writing',
        'admin.writing-tasks.store' => 'writing',
        'admin.writing-tasks.execute' => 'writing',
        'admin.writing-tasks.destroy' => 'writing',
        'admin.viral.index' => 'writing',
        'admin.viral.store' => 'writing',
        'admin.viral.batch' => 'writing',
        'admin.viral.batchStore' => 'writing',
        'admin.viral.destroy' => 'writing',
        'admin.index-check.index' => 'analytics',
        'admin.index-check.create' => 'analytics',
        'admin.index-check.store' => 'analytics',
        'admin.index-check.show' => 'analytics',
        'admin.index-check.destroy' => 'analytics',
        'admin.ai-expand.index' => 'analytics',
        'admin.ai-expand.expand' => 'analytics',
        'admin.tuozhan.index' => 'analytics',
        'admin.tuozhan.generate' => 'analytics',
        'admin.tuozhan.save' => 'analytics',

        'admin.diagnosis.index' => 'geo-optimization',
        'admin.diagnosis.create' => 'geo-optimization',
        'admin.diagnosis.store' => 'geo-optimization',
        'admin.diagnosis.show' => 'geo-optimization',
        'admin.diagnosis.execute' => 'geo-optimization',
        'admin.diagnosis.destroy' => 'geo-optimization',
        'admin.diagnosis.report' => 'geo-optimization',
        'admin.seo.sites.index' => 'geo-optimization',
        'admin.seo.sites.create' => 'geo-optimization',
        'admin.seo.sites.store' => 'geo-optimization',
        'admin.seo.sites.edit' => 'geo-optimization',
        'admin.seo.sites.update' => 'geo-optimization',
        'admin.seo.sites.destroy' => 'geo-optimization',
        'admin.seo.tasks.index' => 'geo-optimization',
        'admin.seo.tasks.create' => 'geo-optimization',
        'admin.seo.tasks.store' => 'geo-optimization',
        'admin.seo.tasks.execute' => 'geo-optimization',
        'admin.seo.tasks.destroy' => 'geo-optimization',
        ...
        'admin.geo-optimization.index' => 'geo-optimization',
        'admin.geo-optimization.rules' => 'geo-optimization',
        'admin.geo-optimization.rules.store' => 'geo-optimization',
        'admin.geo-optimization.rules.toggle' => 'geo-optimization',
        'admin.geo-optimization.rules.delete' => 'geo-optimization',
        'admin.geo-optimization.health' => 'geo-optimization',
        'admin.publish.dashboard' => 'publish',
        'admin.publish-tasks.index' => 'publish',
        'admin.publish-tasks.create' => 'publish',
        'admin.publish-tasks.store' => 'publish',
        'admin.publish-tasks.show' => 'publish',
        'admin.publish-tasks.execute' => 'publish',
        'admin.publish-tasks.destroy' => 'publish',
        'admin.browser-profiles.index' => 'publish',
        'admin.browser-profiles.create' => 'publish',
        'admin.browser-profiles.store' => 'publish',
        'admin.browser-profiles.edit' => 'publish',
        'admin.browser-profiles.update' => 'publish',
        'admin.browser-profiles.destroy' => 'publish',
        'admin.browser-profiles.sync' => 'publish',
